...
class BarcodesForWooCommerce {
    ...
    public function enqueue_admin_scripts( $hook ) {
        ...
        wp_enqueue_script(
            'barcode-scripts',
            plugins_url( 'assets/js/barcode-scripts.js', BARCODES_ROOT_FILE ),
        ...
        wp_enqueue_script(
            'advanced-settings',
            plugins_url( 'assets/js/advanced-settings.js', BARCODES_ROOT_FILE ),
            [ 'jquery' ],
            BARCODES_FOR_WOOCOMMERCE_VERSION,
            true
        );
        ...
        wp_enqueue_script(
            'html5-qrcode',
            plugins_url( 'assets/js/html5-qrcode.min.js', BARCODES_ROOT_FILE ),
            [],
            BARCODES_FOR_WOOCOMMERCE_VERSION,
            true
        );
        ...
        wp_enqueue_style(
            'barcode-styles',
            plugins_url( 'assets/css/barcode-styles.css', BARCODES_ROOT_FILE ),
            [],
            BARCODES_FOR_WOOCOMMERCE_VERSION
        );
